...
import { BookItem, BookListComponent } from './components.js'
 ...
 */
  ...
  const bookListComponent = new BookListComponent(matches, '[data-list-items]', BOOKS_PER_PAGE);
    bookListComponent.renderBookList();
